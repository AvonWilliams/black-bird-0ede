...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/black-bird-0ede)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/black-bird-0ede
```

A live public deployment of this template is available at [https://black-bird-0ede.templates.workers.dev](https://black-bird-0ede.templates.workers.dev)
